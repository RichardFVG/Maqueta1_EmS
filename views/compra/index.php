<div class="row">
    <div class="col-12">
        ...
        <a href="index.php?controller=Compra&action=create" class="btn btn-primary mb-3">
            Añadir Compra
        </a>
        <a href="index.php?controller=Compra&action=downloadXls" class="btn btn-success mb-3">
            Descargar XLS
        </a>
